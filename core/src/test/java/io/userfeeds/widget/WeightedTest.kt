...
class WeightedTest {
    ...
    fun `Should return first item when on the edge`() {
        val otherElement = RankingItem("", BigDecimal(longBitsToDouble(doubleToLongBits(1.0) - 1L)), null, "", null, null)
    ...
    private val String.w get() = RankingItem("", BigDecimal(this), null, "", null, null)
}
